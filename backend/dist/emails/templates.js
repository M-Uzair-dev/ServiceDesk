...
exports.jobScheduledEmail = jobScheduledEmail;
exports.jobEnRouteEmail = jobEnRouteEmail;
exports.jobCompletedEmail = jobCompletedEmail;
exports.jobCancelledEmail = jobCancelledEmail;
exports.jobRequestedEmail = jobRequestedEmail;
function jobScheduledEmail(data) {
    return {
...
function jobCompletedEmail(data) {
    return {
...
function jobCancelledEmail(data) {
    return {
...
function jobRequestedEmail(data) {
    return {
